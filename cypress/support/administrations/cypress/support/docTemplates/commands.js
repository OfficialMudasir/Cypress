...
Cypress.Commands.add("docTemplateCreateFolder", (folderName) => {
  ...
  cy.wait(3000);
  cy.get(TableSelector).should('contain',folderName);
...
// Cypress.Commands.add("docTemplateCreate", (TemplateName) => {
//   cy.wait(1000);
//   cy.get('#CreateNewTemplateButton').should("be.visible");
//   cy.get('#CreateNewTemplateButton').click();

//   cy.get(".modal-title > span").should("have.text", "New Document Template");
//   cy.get("#Template_Name").type(TemplateName);
//   cy.get("#Template_DocumentName").type(TemplateName);
//   cy.get("#Template_Comments").type("Description of " + TemplateName);

//   // cy.get('[name="DocumentTemplate"]').click();
